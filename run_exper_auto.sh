...
ver_pairs=('123' '234' '124' '134' '12' '13' '14' '23' '24' '34') # '12' 
...
for i in {1..3}; do
    for gymid in "${final_str_list[@]}"; do
        ...
        papermill $OUTPUT_DIR/notebook_dql_debug_tiny_auto.ipynb -p gymid "$gymid" -p training_episode_count 2000 $reward $gamma
        #     done
        # done
    done
done