...
global_properties: List[PropertyName] = ["state", "document_a5db38da", "username_password_restrictions", "property.cloudactivedefense"]  # "server",  # Meeting 27.01, shared properties (document, username_password) + global properties (server state)
