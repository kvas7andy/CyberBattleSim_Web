...
global_properties: List[PropertyName] = ["username_password_restrictions"]
    ...
    "client_browser": m.NodeInfo(
        ...
        vulnerabilities=OrderedDict([
            ...
            ("BurpSuiteHeaderScan", VulnerabilityInfo(
                ...
                type=VulnerabilityType.LOCAL,
                outcome=m.concatenate_outcomes((m.ProbeFailed,))(),
                reward_string="Found multiple properties (username, password, server?)",
                cost=1.0
            ))
        ]),
