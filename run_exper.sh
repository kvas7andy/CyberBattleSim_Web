...
INPUT_DIR=cyberbattle/agents/baselines/notebooks

cat $INPUT_DIR/notebook_dql_debug_with_tinymicro.py | jupytext --to ipynb --set-kernel - | papermill $OUTPUT_DIR/notebook_dql_debug_tiny.ipynb -p gymid 'CyberBattleTinyMicro-v0' # -p iteration_count 1500 -p training_episode_count 20 -p eval_episode_count 10
